...
import { convertTimeToStringInMinutes } from "../../../utils/convert-time-string-to-minutes";
        ...
        .transform(intervals => {
            return intervals.map(interval => {
                return {
                    ...
                    startTimeInMinutes: convertTimeToStringInMinutes(interval.startTime),
                    endTimeInMinutes: convertTimeToStringInMinutes(interval.endTime)
                }
            })
        })
        .refine(intervals => {
            ...
            message: 'O horário de término deve ser pelo menos 1h distante do horário de início.'
        })
})
...
export default function TimeIntervals() {
    const { register, handleSubmit, watch, formState: { isSubmitting, errors }, control } = useForm<TimeIntervalsFormInput>({
